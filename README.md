...
A mail service built **from scratch using Go**.
...
I'm actively learning Go while building this project, so the architecture and implementation will evolve as I learn more.

The long-term goal is to understand what it takes to build the core infrastructure behind services like Resend, SendGrid, and Mailgun.

##  Why I'm Building This

 learn a compiled backend language and understand backend infrastructure at a deeper level.
