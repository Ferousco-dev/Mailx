...
- RSK-022 [low, v0.28]: alignment uses the PSL while receivers following RFC 9989 use a DNS tree walk; results can differ for domains under public-suffix operators publishing `psd=` records. Not observed in practice for ordinary registrable domains.
